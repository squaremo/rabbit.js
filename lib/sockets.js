...
ReqSocket.prototype.connect = function(destination, callback) {
  var self = this, ch = this.ch;
  ch.assertQueue(destination, {durable: this.options.persistent, autoDelete: this.options.autoDelete || false})
    .then(function(ok) {
...
RepSocket.prototype.connect = function(source, callback) {
  ...
  ch.assertQueue(source, {durable: this.options.persistent, autoDelete: this.options.autoDelete || false})
    .then(function(ok) {
      return ch.consume(source, function(msg) {
        if (msg !== null) {

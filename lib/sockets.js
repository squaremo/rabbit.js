...
JobSocket.prototype.next = function(msg, socket, nextMsg, encoding) {
...
SendSocket.prototype.connect = function(destination, callback) {
  var self = this, ch = this.ch;
  ch.assertExchange(destination, this.options.routing || 'fanout', {durable: this.options.durable || true, autoDelete: this.options.autoDelete})
    .then(function(ok) {
      self.pubs.push(destination);
    }).then(callback);
};
